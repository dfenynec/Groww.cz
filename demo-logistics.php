<!doctype html>
    <html class="no-js" lang="cs">
          <head>
        <title>Groww. weby jednoduše</title>
        <meta charset="utf-8">
        ...
        <body data-mobile-nav-style="classic">
                        ...
                        <div class="row h-45px align-items-center m-0">
                            <div class="col-12 col-lg-7 fw-500 justify-content-lg-start justify-content-center">
                                <span class="me-25px fs-15 md-m-0">
                                    <i class="feather icon-feather-phone-call text-base-color me-10px"></i><span class="text-light-gray">Telefon: 1 800 222 000 – nonstop 24/7</span>
                                </span>
                    ...
                    <div class="container-fluid"> 
                        ...
                        <div class="col-auto menu-order left-nav">
                            ...
                            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                                <ul class="navbar-nav">
                                    <li class="nav-item"><a href="demo-logistics.html" class="nav-link">Domů</a></li> 
                                    <li class="nav-item"><a href="demo-logistics-about-us.html" class="nav-link">O nás</a></li>
                                    <li class="nav-item dropdown dropdown-with-icon-style02"><a href="demo-logistics-our-services.html" class="nav-link">Naše služby</a>
                                        <i class="fa-solid fa-angle-down dropdown-toggle" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"></i>
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink"> 
                                            <li><a href="demo-logistics-services-details.html"><i class="line-icon-Plane-2 align-middle text-base-color"></i>Letecká přeprava</a></li>
                                            <li><a href="demo-logistics-services-details.html"><i class="line-icon-Road-3 align-middle text-base-color"></i>Silniční přeprava</a></li>
                                            <li><a href="demo-logistics-services-details.html"><i class="line-icon-Ship-2 align-middle text-base-color"></i>Námořní přeprava</a></li>
                                            <li><a href="demo-logistics-services-details.html"><i class="line-icon-Tram align-middle text-base-color"></i>Železniční přeprava</a></li>
                                        </ul>
                                    </li>
                                    <li class="nav-item"><a href="demo-logistics-latest-blog.html" class="nav-link">Aktuality</a></li>
                                    <li class="nav-item"><a href="demo-logistics-contact-us.html" class="nav-link">Kontaktujte nás</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="header-icon">
                                ...
                                <div class="header-button ms-25px">
                                    <a href="demo-logistics-contact-us.html" class="btn btn-small btn-base-color btn-hover-animation-switch btn-round-edge btn-box-shadow fw-700 ls-0px btn-icon-left">
                                        <span> 
                                            <span class="btn-text">Nezávazná poptávka</span>
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="container h-100">
                                <div class="row align-items-center h-100 xl-ps-10 sm-ps-0">
                                    <div class="col-xxl-7 col-xl-10 text-white">
                                        <h1 class="fw-600">Důvěryhodná logistická agentura pro digitální dobu</h1>  
                                        <div class="fs-20 opacity-6 mb-40px sm-mb-30px">Flexibilní služby, vyšší úroveň servisu a spolehlivé doručení.</div>
                                        <div class="lg-mb-8 md-mb-0">
                                            <a href="demo-logistics-about-us.html" class="btn btn-white btn-extra-large btn-round-edge fw-700 btn-box-shadow me-35px">Poznat agenturu</a>
                                            <a href="https://www.youtube.com/watch?v=cfXHhfNy7tU" class="text-center d-inline-flex sm-mt-20px rounded-circle video-icon-box video-icon-medium popup-vimeo">
                                                ...
                                                <span class="text-white fs-20">Jak to funguje?</span>
                                            </a>
                                        </div>
                                    </div>
                                </div> 
                        ...
                        <div class="swiper-slide cover-background" style="background-image:url('https://craftohtml.themezaa.com/images/demo-logistics-slider-02.jpg');"> 
                            <div class="container h-100">
                                <div class="row align-items-center h-100 xl-ps-10 sm-ps-0">
                                    <div class="col-xxl-7 col-xl-10 text-white">
                                        <h1 class="fw-600">Globální partner pro leteckou přepravu</h1>  
                                        <div class="fs-20 opacity-6 mb-40px sm-mb-30px">Rychlá a spolehlivá letecká přeprava po celém světě.</div>
                                        <div class="lg-mb-8 md-mb-0">
                                            <a href="demo-logistics-about-us.html" class="btn btn-white btn-extra-large btn-round-edge fw-700 btn-box-shadow me-35px">Poznat agenturu</a>
                                            <a href="https://www.youtube.com/watch?v=cfXHhfNy7tU" class="text-center d-inline-flex sm-mt-20px rounded-circle video-icon-box video-icon-medium popup-vimeo">
                                                <span class="video-icon bg-base-color me-10px">
                        ...
                        <div class="swiper-slide cover-background" style="background-image:url('https://craftohtml.themezaa.com/images/demo-logistics-slider-03.jpg');"> 
                            <div class="container h-100">
                                <div class="row align-items-center h-100 xl-ps-10 sm-ps-0">
                                    <div class="col-xxl-7 col-xl-10 text-white">
                                        <h1 class="fw-600">Železniční nákladní přeprava po celé zemi</h1>  
                                        <div class="fs-20 opacity-6 mb-40px sm-mb-30px">Spolehlivá železniční přeprava pro bezproblémovou logistiku.</div>
                                        <div class="lg-mb-8 md-mb-0">
                                            <a href="demo-logistics-about-us.html" class="btn btn-white btn-extra-large btn-round-edge fw-700 btn-box-shadow me-35px">Poznat agenturu</a>
                                            <a href="https://www.youtube.com/watch?v=cfXHhfNy7tU" class="text-center d-inline-flex sm-mt-20px rounded-circle video-icon-box video-icon-medium popup-vimeo">
                                                <span class="video-icon bg-base-color me-10px">
                        ...
                        <div class="col-xl-5 outside-box-top-205px lg-mt-0 position-relative z-index-1">
                            <div class="border-radius-10px overflow-hidden">
                                ...
                                <div class="bg-dark-gray ps-50px pe-50px pt-20px pb-20px sm-ps-30px sm-pe-30px">
                                    <a href="demo-logistics-contact-us.html" class="fs-19 fw-500 text-white d-flex w-100 align-items-center">Získejte nezávaznou nabídku<i class="feather icon-feather-plus ms-auto icon-extra-medium"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-xl-5 col-lg-6 col-md-10 offset-xl-1" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            ...
                            <p class="w-90 lg-w-100">Jsme spolehlivý logistický partner poskytující kompletní služby včetně celního odbavení kdekoliv na světě pro jakýkoliv typ zásilky.</p>
                            <div class="icon-with-text-style-08 mb-10px">
                                <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                    ...
                                    <div class="feature-box-content"> 
                                        <span class="text-dark-gray fw-500">Naše hodnoty nás spojují a vedou.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="icon-with-text-style-08 mb-10px">
                                <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                    ...
                                    <div class="feature-box-content"> 
                                        <span class="text-dark-gray fw-500">Zavazujeme se k udržitelnému růstu.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-35px d-flex flex-wrap">
                                <a href="demo-logistics-our-services.html" class="btn btn-large btn-dark-gray btn-hover-animation-switch btn-round-edge btn-box-shadow btn-icon-right me-30px">
                                    <span> 
                                        <span class="btn-text">Naše služby</span>
                                ...
                                <div class="feature-box feature-box-left-icon-middle xs-mt-20px">
                                    ...
                                    <div class="feature-box-content">
                                        <span class="d-block fw-500">Spojte se s námi</span>
                ...
                <div class="container">
                    <div class="row justify-content-center mb-3 xs-mb-2">
                        <div class="col-lg-7 text-center" data-anime='{ "el": "childs", "opacity": [0, 1], "translateY": [0, 0], "staggervalue": 200, "easing": "easeInOutSine" }'>
                            <span class="fs-16 lh-22 fw-700 mb-10px d-inline-block text-uppercase text-dark-gray border-bottom border-2 border-color-base-color">Profesionální služby</span>
                            <h2 class="text-dark-gray fw-700 mb-0 ls-minus-1px">Logistické služby</h2>
                        </div>
                    </div>
                    <div class="row">
                                            ...
                                            <div class="row g-0 services-box-style-02"> 
                                                <div class="col-sm-6 services-box bg-white p-10 xxl-p-8 xl-p-6 box-shadow-extra-large">
                                                    ...
                                                    <div class="services-box-content">
                                                        <a href="demo-logistics-our-services.html" class="d-inline-block text-dark-gray fs-22 fw-700 mb-5px">Letecká přeprava</a>
                                                        <p class="mb-15px">Komplexní řešení letecké přepravy s důrazem na rychlost a bezpečnost.</p>
                                                        <a href="demo-logistics-our-services.html" class="btn btn-extra-large thin btn-link text-dark-gray p-0">Více informací</a>
                                                    </div> 
                                                </div> 
                                        ...
                                        <div class="swiper-slide">
                                            <div class="row g-0 services-box-style-02"> 
                                                <div class="col-sm-6 services-box bg-white p-10 xxl-p-8 xl-p-6 box-shadow-extra-large">
                                                    ...
                                                    <div class="services-box-content">
                                                        <a href="demo-logistics-our-services.html" class="d-inline-block text-dark-gray fs-22 fw-700 mb-5px">Námořní přeprava</a>
                                                        <p class="mb-15px">Efektivní námořní přeprava s globálním pokrytím a transparentními náklady.</p>
                                                        <a href="demo-logistics-our-services.html" class="btn btn-extra-large thin btn-link text-dark-gray p-0">Více informací</a>
                                                    </div> 
                                                </div> 
                                                <div class="col-sm-6 services-box-img xs-h-300px">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="row g-0 services-box-style-02"> 
                                                <div class="col-sm-6 services-box bg-white p-10 xxl-p-8 xl-p-6 box-shadow-extra-large">
                                                    ...
                                                    <div class="services-box-content">
                                                        <a href="demo-logistics-our-services.html" class="d-inline-block text-dark-gray fs-22 fw-700 mb-5px">Silniční přeprava</a>
                                                        <p class="mb-15px">Flexibilní silniční doprava pro domácí i mezinárodní zásilky.</p>
                                                        <a href="demo-logistics-our-services.html" class="btn btn-extra-large thin btn-link text-dark-gray p-0">Více informací</a>
                                                    </div> 
                                                </div> 
                                                <div class="col-sm-6 services-box-img xs-h-300px">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="row g-0 services-box-style-02"> 
                                                <div class="col-sm-6 services-box bg-white p-10 xxl-p-8 xl-p-6 box-shadow-extra-large">
                                                    ...
                                                    <div class="services-box-content">
                                                        <a href="demo-logistics-our-services.html" class="d-inline-block text-dark-gray fs-22 fw-700 mb-5px">Železniční přeprava</a>
                                                        <p class="mb-15px">Ekologická a spolehlivá přeprava po železnici za výhodných podmínek.</p>
                                                        <a href="demo-logistics-our-services.html" class="btn btn-extra-large thin btn-link text-dark-gray p-0">Více informací</a>
                                                    </div> 
                                                </div> 
                                                <div class="col-sm-6 services-box-img xs-h-300px">
                ...
                <div class="container">
                    <div class="row align-items-center mb-8 sm-mb-50px justify-content-md-center"> 
                        <div class="col-xl-5 col-lg-6 col-md-12 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'> 
                            <span class="fs-16 lh-22 fw-700 mb-10px d-inline-block text-uppercase text-dark-gray border-bottom border-2 border-color-base-color">Proč si vybrat nás?</span>
                            <h2 class="text-dark-gray fw-700 mb-20px ls-minus-1px">Silné stránky našeho skladu</h2>
                                    ...
                                    <div class="accordion accordion-style-02" id="accordion-style-02" data-active-icon="icon-feather-minus" data-inactive-icon="icon-feather-plus">
                                        ...
                                        <div class="accordion-item active-accordion">
                                            ...
                                            <div id="accordion-style-02-01" class="accordion-collapse collapse show" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin border-bottom sm-pe-0">
                                                    <p>Chráníme vaše zásilky po celou dobu přepravy – od vyzvednutí po doručení.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end accordion item -->
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="accordion-style-02-02" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin border-bottom sm-pe-0">
                                                    <p>Aktuální informace o stavu zásilky v reálném čase na jednom místě.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end accordion item -->
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="accordion-style-02-03" class="accordion-collapse collapse" data-bs-parent="#accordion-style-02">
                                                <div class="accordion-body last-paragraph-no-margin sm-pe-0">
                                                    <p>Potvrzení doručení a kontrola úplnosti s jasnou dokumentací.</p>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end accordion item -->
                            ...
                            <div>
                                <a href="demo-logistics-our-services.html" class="btn btn-large btn-dark-gray btn-hover-animation-switch btn-round-edge btn-box-shadow me-15px">
                                    <span> 
                                        <span class="btn-text">Prozkoumat více</span>
                                        <span class="btn-icon"><i class="feather icon-feather-arrow-right"></i></span>
                                        <span class="btn-icon"><i class="feather icon-feather-arrow-right"></i></span>
                                    </span>
                                </a>
                    ...
                    <div class="row row-cols-1 row-cols-lg-4 row-cols-sm-2 justify-content-center counter-style-07" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        ...
                        <div class="col text-center md-mb-50px xs-mb-30px">
                            ...
                            <span class="d-block fw-600 text-dark-gray">Zákazníci po celém světě</span>
                        </div>
                        <!-- end counter item -->
                        <!-- start counter item -->
                        <div class="col text-center md-mb-50px xs-mb-30px">
                            <h2 class="vertical-counter d-inline-flex text-dark-gray fw-800 mb-0 ls-minus-3px position-relative z-index-0" data-to="8583">
                                <span class="text-highlight position-absolute bottom-13px w-100"><span class="bg-base-color h-10px opacity-7"></span></span>
                            </h2>
                            <span class="d-block fw-600 text-dark-gray">Doručené zásilky</span>
                        </div>
                        <!-- end counter item -->
                        <!-- start counter item -->
                        <div class="col text-center xs-mb-30px">
                            ...
                            <span class="d-block fw-600 text-dark-gray">Najeté míle</span>
                        </div>
                        <!-- end counter item -->
                        <!-- start counter item -->
                        <div class="col text-center">
                            <h2 class="vertical-counter d-inline-flex text-dark-gray fw-800 mb-0 ls-minus-3px position-relative z-index-0" data-to="1236">
                                <span class="text-highlight position-absolute bottom-13px w-100"><span class="bg-base-color h-10px opacity-7"></span></span>
                            </h2>
                            <span class="d-block fw-600 text-dark-gray">Počet zaměstnanců</span>
                        </div>
                        <!-- end counter item -->
                    </div>
                </div>
                ...
                <div class="container position-relative z-index-1">
                    <div class="row">
                        <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-10" data-anime='{ "translateX": [-30, 0], "opacity": [0,1], "duration": 1200, "delay": 100, "staggervalue": 150, "easing": "easeOutQuad" }'>
                            <span class="fs-16 lh-22 fw-600 mb-15px d-inline-block text-uppercase text-white border-bottom border-2 border-color-base-color xs-border-bottom-0">Několik dobrých důvodů</span>
                            <h2 class="fw-600 text-white">Co o nás říkají klienti</h2>
                            <div class="swiper position-relative" data-slider-options='{ "autoHeight": true, "loop": true, "allowTouchMove": true, "autoplay": { "delay": 4000, "disableOnInteraction": false }, "navigation": { "nextEl": ".swiper-button-next", "prevEl": ".swiper-button-prev" }, "effect": "fade" }'>
                                <div class="swiper-wrapper mb-40px">
                                    ...
                                    <div class="swiper-slide review-style-08">
                                        <p class="text-white opacity-7 w-80 lg-w-100">Skvělá šablona, přehledná a velmi snadno použitelná. Nejvíce oceňuji podporu – Vaše společnost vyřešila všechny mé problémy s individuálním nastavením.</p>
                                        <div class="mt-20px">
                                            <img class="w-110px me-15px" src="https://placehold.co/270x245" alt="">
                                    ...
                                    <!-- start text slider item -->
                                    <div class="swiper-slide review-style-08">
                                        <p class="text-white opacity-7 w-80 lg-w-100">Zakoupil(a) jsem už několik šablon, ale tahle je suverénně nejlepší. Je výborně postavená, promyšlená a nabízí téměř neomezené možnosti nastavení.</p>
                                        <div class="mt-20px">
                                            <img class="w-110px me-15px" src="https://placehold.co/270x245" alt="">
                                            <div class="d-inline-block align-middle text-start">
                                    ...
                                    <!-- start text slider item -->
                                    <div class="swiper-slide review-style-08">
                                        <p class="text-white opacity-7 w-80 lg-w-100">Šablona je velmi kvalitní a dobře přizpůsobitelná různým potřebám, ale nejvíce mě nadchla spolupráce s týmem podpory.</p>
                                        <div class="mt-20px">
                                            <img class="w-110px me-15px" src="https://placehold.co/270x245" alt="">
                                            <div class="d-inline-block align-middle text-start">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-xl-5 col-lg-6 ps-70px lg-ps-15px" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 300, "staggervalue": 300, "easing": "easeOutQuad" }'> 
                            ...
                            <h2 class="fw-700 text-dark-gray ls-minus-1px mb-20px w-80 xxl-w-100">Špičkové služby po celém světě</h2>
                            <p class="w-75 xxl-w-100 mb-30px">Máme více než 20 let zkušeností v oblasti importu, exportu a logistických služeb. Od roku 2020 působíme se službami napříč všemi zeměmi světa.</p>
                            <div>
                                <a href="demo-logistics-our-services.html" class="btn btn-large btn-dark-gray btn-hover-animation-switch btn-round-edge btn-box-shadow me-15px">
                                    <span> 
                                        <span class="btn-text">Prozkoumat více</span>
            ...
            <!-- end section -->
            <!-- start section -->
            <section class="ps-8 pe-8 lg-ps-4 lg-pe-4 md-ps-0 md-pe-0 py-0">
                <div class="container-fluid">
                    <div class="row g-0 bg-very-light-gray justify-content-center border-radius-10px overflow-hidden flex-lg-row flex-column-reverse">
                        <div class="col-lg-8 p-6 lg-p-50px xs-ps-30px xs-pe-30px">
                            <span class="fs-16 lh-22 fw-700 mb-15px d-inline-block text-uppercase text-dark-gray border-bottom border-2 border-color-base-color">Špičková logistika</span>
                            <h2 class="fw-700 text-dark-gray ls-minus-1px mb-45px">Kalkulačka cen logistiky</h2>
                            <!-- start contact form -->
                            <form action="email-templates/contact-form.php" method="post" class="row contact-form-style-01">    
                                <div class="col-md-6 mb-30px sm-mb-20px">
                                    <div class="position-relative form-group mb-20px">
                                        ...
                                        <input class="input-name box-shadow-double-large form-control required" type="text" name="name" placeholder="Vaše jméno" />
                                    </div>
                                    <div class="position-relative form-group mb-20px">
                                        <span class="form-icon"><i class="bi bi-envelope"></i></span>
                                        <input class="box-shadow-double-large form-control required" type="email" name="email" placeholder="Váš e‑mail" />
                                    </div>
                                    <div class="position-relative form-group select mb-20px">
                                        ...
                                        <select class="form-control box-shadow-double-large" name="booking-city" aria-label="select-city-booking">
                                            <option value="">Místo vyzvednutí</option>
                                            <option value="Uk">Město – Spojené království</option>
                                            <option value="Usa">Město – USA</option>
                                            <option value="Canada">Město – Kanada</option>
                                            <option value="Dubai">Město – Dubaj</option>
                                            <option value="Singapore">Město – Singapur</option>
                                        </select>
                                    </div>
                                    <div class="position-relative form-group form-textarea">
                                        <span class="form-icon"><i class="bi bi-globe2"></i></span>
                                        <textarea class="box-shadow-double-large form-control" cols="40" rows="4" name="booking-address" placeholder="Adresa vyzvednutí"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-30px">
                                    <div class="position-relative form-group mb-20px">
                                        <span class="form-icon"><i class="bi bi-telephone-outbound"></i></span>
                                        <input class="input-name box-shadow-double-large form-control required" type="text" name="phone" placeholder="Vaše mobilní číslo" />
                                    </div>
                                    <div class="position-relative form-group mb-20px">
                                        <span class="form-icon"><i class="bi bi-speedometer2"></i></span>
                                        <input class="box-shadow-double-large form-control required" type="number" name="weight" min="1" max="1000" placeholder="Hmotnost v kg" />
                                    </div>
                                    <div class="position-relative form-group select mb-20px">
                                        <span class="form-icon"><i class="bi bi-flag"></i></span>
                                        <select class="form-control box-shadow-double-large" name="delivery-city" aria-label="select-city-delivery">
                                            <option value="">Místo doručení</option>
                                            <option value="Uk">Město – Spojené království</option>
                                            <option value="Usa">Město – USA</option>
                                            <option value="Canada">Město – Kanada</option>
                                            <option value="Dubai">Město – Dubaj</option>
                                    ...
                                    <div class="position-relative form-group form-textarea">
                                        ...
                                        <textarea class="box-shadow-double-large form-control" cols="40" rows="4" name="delivery-address" placeholder="Doručovací adresa"></textarea>
                                    </div>
                                </div>
                                <div class="col-auto text-center text-md-end sm-mt-20px lg-mb-15px">
                                    ...
                                    <button class="btn btn-dark-gray btn-switch-text btn-medium left-icon btn-round-edge submit btn-box-shadow" type="submit">
                                        <span>
                                            ...
                                            <span class="btn-double-text" data-text="Get a quote">Nezávazná poptávka</span> 
                                        </span>
                                    </button>
                                </div>
                                <div class="col-xl-7 align-self-center last-paragraph-no-margin">
                                    <p class="fs-16 lh-24 w-80 xxl-w-100">*Dbáme na ochranu vašeho soukromí. Vaše údaje zpracováváme odpovědně a bezpečně.</p>
                                </div>
                                <div class="col-12">
                ...
                <div class="container">
                    <div class="row justify-content-center mb-3">
                        <div class="col-lg-7 text-center" data-anime='{ "opacity": [0,1], "duration": 800, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <span class="fs-16 lh-22 fw-700 mb-15px d-inline-block text-uppercase text-dark-gray border-bottom border-2 border-color-base-color">Novinky a aktuality</span>
                            <h2 class="text-dark-gray fw-700 ls-minus-1px mb-0">Nejnovější aktuality</h2>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <li class="grid-item">
                                    <div class="card border-0 border-radius-4px box-shadow-quadruple-large">
                                        ...
                                        <div class="card-body p-13 md-p-11">
                                            ...
                                            <p>Stručný přehled klíčových trendů a jejich dopadu na odvětví.</p>
                                            <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-16">
                                                <div class="me-auto">
                                                    <span class="blog-date d-inline-block text-dark-gray fw-600">30. srpna 2024</span>
                                                    <div class="d-inline-block author-name">Autor: <a href="demo-logistics-latest-blog.html" class="text-dark-gray text-decoration-line-bottom fw-600">Den viliamson</a></div>
                                                </div>
                                                <div class="like-count fs-15 fw-600">
                                                    <a href="demo-logistics-blog-single-modern.html"><i class="fa-regular fa-heart text-red"></i><span class="text-dark-gray align-middle">65</span></a>
                                                </div>  
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="grid-item">
                                    <div class="card border-0 border-radius-4px box-shadow-quadruple-large">
                                        ...
                                        <div class="card-body p-13 md-p-11">
                                            ...
                                            <p>Jak digitalizace zvyšuje efektivitu a snižuje náklady v logistice.</p>
                                            <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-16">
                                                <div class="me-auto">
                                                    <span class="blog-date d-inline-block text-dark-gray fw-600">28. srpna 2024</span>
                                                    <div class="d-inline-block author-name">Autor: <a href="demo-logistics-latest-blog.html" class="text-dark-gray text-decoration-line-bottom fw-600">Hugh macleod</a></div>
                                                </div>
                                                <div class="like-count fs-15 fw-600">
                                                    <a href="demo-logistics-blog-single-modern.html"><i class="fa-regular fa-heart text-red"></i><span class="text-dark-gray align-middle">25</span></a>
                                                </div>  
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <li class="grid-item">
                                    <div class="card border-0 border-radius-4px box-shadow-quadruple-large">
                                        ...
                                        <div class="card-body p-13 md-p-11">
                                            ...
                                            <p>Strategie pro stabilní a škálovatelný mezinárodní provoz.</p>
                                            <div class="author d-flex justify-content-center align-items-center position-relative overflow-hidden fs-16">
                                                <div class="me-auto">
                                                    <span class="blog-date d-inline-block text-dark-gray fw-600">26. srpna 2024</span>
                                                    <div class="d-inline-block author-name">Autor: <a href="demo-logistics-latest-blog.html" class="text-dark-gray text-decoration-line-bottom fw-600">Walton smith</a></div>
                                                </div>
                                                <div class="like-count fs-15 fw-600">
                                                    <a href="demo-logistics-blog-single-modern.html"><i class="fa-regular fa-heart text-red"></i><span class="text-dark-gray align-middle">30</span></a>
                                                </div>  
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-8 col-lg-9 col-md-11 icon-with-text-style-08 md-mb-20px">
                            <div class="feature-box feature-box-left-icon-middle overflow-hidden">
                                ...
                                <div class="feature-box-content last-paragraph-no-margin">
                                    ...
                                    <p class="fs-19 text-dark-gray opacity-8 fw-500">Důvěřuje nám více než 30 000 zákazníků po celém světě od roku 2024.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container"> 
                    <div class="row justify-content-center pt-6 sm-pt-40px text-sm-start text-center">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-sm-6 md-mb-30px">
                            ...
                            <div class="row align-items-center border border-color-transparent-white-light g-0 border-radius-4px">
                                ...
                                <div class="col-7 border-start border-color-transparent-white-light ps-20px pe-20px pt-15px pb-15px lg-ps-15px lg-pe-15px text-center text-sm-start">
                                    ...
                                    <span class="d-block fs-18">30 tisíc hodnocení</span>
                                </div>
                            </div>
                        </div>
                        <!-- end footer column -->
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-5 offset-xl-1 offset-md-0 offset-sm-1 md-mb-30px">
                            <span class="fs-18 d-block text-white fw-500 mb-10px">O službách</span>
                            <ul>
                                <li><a href="demo-logistics-services-details.html">Letecká přeprava</a></li>
                                <li><a href="demo-logistics-services-details.html">Námořní přeprava</a></li>
                                <li><a href="demo-logistics-services-details.html">Silniční přeprava</a></li>
                                <li><a href="demo-logistics-services-details.html">Skladování</a></li>
                                <li><a href="demo-logistics-services-details.html">Řízení dodavatelského řetězce</a></li>
                            </ul>
                        </div>
                        <!-- end footer column -->
                        <!-- start footer column -->
                        <div class="col-lg-3 col-md-4 col-sm-5 offset-md-0 offset-sm-1 order-5 order-md-3 xs-mb-30px">
                            <span class="fs-18 d-block text-white fw-500 mb-10px">Potřebujete pomoc?</span>
                            <span class="d-block">Zavolejte nám:</span>
                            <a href="tel:1800222000" class="mb-15px d-inline-block">1 800 222 000</a>
                            <span class="d-block">Potřebujete živou podporu?</span>
                        ...
                        <div class="col-lg-3 col-md-10 col-sm-6 text-md-center text-lg-start order-last order-sm-4">
                            <span class="fs-18 d-block text-white fw-500 mb-10px">Zůstaňte s námi v kontaktu</span>
                            <p class="mb-20px fs-17 mx-auto xs-w-90">Přihlaste se k odběru novinek a získejte nejnovější informace.</p>
                            <div class="d-inline-block w-100 newsletter-style-02 position-relative mb-15px">
                                <form action="email-templates/subscribe-newsletter.php" method="post" class="position-relative w-100">
                                    <input class="bg-transparent border-color-transparent-white-light w-100 form-control required" type="email" name="email" placeholder="Zadejte svůj e‑mail">
                                    <input type="hidden" name="redirect" value="">
                            ...
                            <div class="d-flex align-items-center justify-content-lg-start justify-content-md-center justify-content-sm-start justify-content-center">
                                ...
                                <span class="fs-16">Chráníme vaše soukromí</span>
                            </div>
                        </div>
                        <!-- end footer column -->
                    </div> 
                    <div class="row justify-content-center align-items-center pt-5 md-pt-30px">
                        ...
                        <div class="col-lg-9 pt-25px pb-25px fs-15 last-paragraph-no-margin text-center order-2 order-sm-1"><p>Tento web je chráněn službou reCAPTCHA a vztahují se na něj Zásady ochrany osobních údajů a Smluvní podmínky společnosti Google. Pokud s těmito pravidly nesouhlasíte, web nepoužívejte.</p></div>
                    </div>
                      <!-- start Groww footer -->
                     <div class="container-fluid">
                        <div class="d-flex justify-content-end pb-3 align-items-center flex-wrap">
                        <span class="me-2">© 2025 Vaše společnost by</span>
                        <a href="index.html">
                            <img src="images/Logo_allwhite.png" alt="Logo" class=" mb-2 mb-md-0 me-2 img-fluid" style="max-width:100px;" data-no-retina="">
                        </a>
                        </div>
                     </div>
                       <!-- end Groww footer -->
