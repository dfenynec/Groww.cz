                    ...
                    <div class="col-auto text-end d-none d-sm-flex">
                        <div class="header-icon">       
                            <div class="header-button">
                                 <a href="sablony.php" target="_blank" class="btn inner-link btn-large btn-white btn-hover-animation-switch btn-rounded text-dark-gray btn-box-shadow me-20px fw-400 xs-mt-10px xs-mb-10px">
                                <span> 
