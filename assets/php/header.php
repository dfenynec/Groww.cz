            ...
            <div class="col-auto col-lg-2 text-end d-none d-sm-flex">
                <div class="header-icon">       
                    <div class="header-button">
                        <a href="https://shopify.pxf.io/yqrPQB" target="_blank" class="btn btn-large btn-white btn-rounded btn-box-shadow  fw-600 xs-mt-10px xs-mb-10px">Vyzkoušejte Shopify</a>
                    </div>
                </div>                
            </div>
        </div>
