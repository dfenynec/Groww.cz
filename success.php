  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-7 col-md-9">
        <div class="bg-very-light-gray border-radius-6px p-50px lg-p-25px text-center box-shadow-large">
          <span class="fs-32 alt-font fw-700 text-dark-gray mb-20px d-block">Děkujeme za platbu!</span>
          <p class="fs-18 text-dark-gray mb-20px">
            Vaše objednávka byla úspěšně dokončena.<br>
            První měsíc správy reklam je zdarma.<br>
            Brzy vás kontaktujeme ohledně nastavení přístupu k reklamním systémům Google Ads nebo Sklik.
          </p>
          <p class="fs-16 text-dark-gray mb-30px">
            Pokud máte jakékoliv dotazy, neváhejte nás kontaktovat:<br>
            <b>Telefon:</b> <a href="tel:608909981" class="text-dark-gray">608 909 981</a><br>
            <b>Email:</b> <a href="mailto:dfenynec@gmail.com" class="text-dark-gray">dfenynec@gmail.com</a>
          </p>
          <a href="/" class="btn btn-dark-gray btn-large btn-switch-text btn-round-edge btn-box-shadow mt-10px">
            <span>
              <span class="btn-double-text" data-text="Zpět na hlavní stránku">Zpět na hlavní stránku</span>
            </span>
          </a>
        </div>
      </div>
